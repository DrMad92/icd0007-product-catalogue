 ...
 */
abstract class Subcategory implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SubcategoryTableMap';
    ...
    /**
     * Initializes internal state of Base\Subcategory object.
     */
    ...
    /**
     * Compares this with another <code>Subcategory</code> instance.  If
     * <code>obj</code> is an instance of <code>Subcategory</code>, delegates to
     * <code>equals(Subcategory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Subcategory The current object, for fluid interface
     */
     ...
     * @return $this|\Subcategory The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SubcategoryTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[SubcategoryTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SubcategoryTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SubcategoryTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = SubcategoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Subcategory'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSubcategoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Subcategory::setDeleted()
     * @see Subcategory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSubcategoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SubcategoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[SubcategoryTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SubcategoryTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(SubcategoryTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(SubcategoryTableMap::COL_NAME)) {
    ...
    {
        $pos = SubcategoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Subcategory'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Subcategory'][$this->hashCode()] = true;
        $keys = SubcategoryTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    {
        $criteria = new Criteria(SubcategoryTableMap::DATABASE_NAME);

        if ($this->isColumnModified(SubcategoryTableMap::COL_ID)) {
            $criteria->add(SubcategoryTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SubcategoryTableMap::COL_NAME)) {
            $criteria->add(SubcategoryTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildSubcategoryQuery::create();
        $criteria->add(SubcategoryTableMap::COL_ID, $this->id);
     ...
     * If this ChildSubcategory is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSubcategory The current object (for fluent API support)
     */
    public function setCategorySubcategories(Collection $categorySubcategories, ConnectionInterface $con = null)
    {
        ...
        foreach ($categorySubcategoriesToDelete as $categorySubcategoryRemoved) {
            $categorySubcategoryRemoved->setSubcategory(null);
        }
     ...
     * @return ObjectCollection|ChildCategorySubcategory[] List of ChildCategorySubcategory objects
     */
    public function getCategorySubcategoriesJoinCategory(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCategorySubcategoryQuery::create(null, $criteria);
    ...
    public function setProducts(Collection $products, ConnectionInterface $con = null)
    {
        ...
        foreach ($productsToDelete as $productRemoved) {
            $productRemoved->setSubcategory(null);
        }
    ...
    {
        return (string) $this->exportTo(SubcategoryTableMap::DEFAULT_STRING_FORMAT);
    }
